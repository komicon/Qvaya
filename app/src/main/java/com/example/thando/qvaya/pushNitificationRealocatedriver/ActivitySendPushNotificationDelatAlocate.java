...
public class ActivitySendPushNotificationDelatAlocate extends AppCompatActivity implements RadioGroup.OnCheckedChangeListener, View.OnClickListener {
    ...
    private void loadRegisteredDevices() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, EndPointsDelatAlocate.URL_FETCH_DEVICES,
                        ...
                        try {
                            ...
                            if (!obj.getBoolean("error")) {
                                ...
                                ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(
                                        ActivitySendPushNotificationDelatAlocate.this,
    ...
    private void sendMultiplePush() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, EndPointsDelatAlocate.URL_SEND_MULTIPLE_PUSH,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        progressDialog.dismiss();

                        Toast.makeText(ActivitySendPushNotificationDelatAlocate.this, response, Toast.LENGTH_LONG).show();
                    }
                },
                new Response.ErrorListener() {
                    @Override
