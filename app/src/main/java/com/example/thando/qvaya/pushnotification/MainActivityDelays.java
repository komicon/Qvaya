...
public class  MainActivityDelays  extends AppCompatActivity implements View.OnClickListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_delays);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, EndPointsDelays.URL_REGISTER_DEVICE,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            Toast.makeText(MainActivityDelays.this, obj.getString("message"), Toast.LENGTH_LONG).show();
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        progressDialog.dismiss();
                        Toast.makeText(MainActivityDelays.this, error.getMessage(), Toast.LENGTH_LONG).show();
                    }
                }) {
    ...
    public void onClick(View view) {
        ...
        if (view == buttonSendPush) {
            startActivity(new Intent(this, ActivitySendPushNotificationDelay.class));
        }
    }
