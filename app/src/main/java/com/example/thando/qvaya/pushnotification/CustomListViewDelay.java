...
public class CustomListViewDelay  extends ArrayAdapter<String> {
    ...
    public CustomListViewDelay(Activity context,String[] profilename,String[] email,String[] imagepath) {
        super(context, R.layout.layoutdelay,profilename);
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent){
        ...
        if(r==null){
            ...
            r=layoutInflater.inflate(R.layout.layoutdelay,null,true);
