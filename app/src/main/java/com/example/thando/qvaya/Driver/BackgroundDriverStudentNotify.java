...
public class BackgroundDriverStudentNotify  extends AsyncTask<String,Void,String> {
    ...
    public BackgroundDriverStudentNotify (Context ctx)
    {
        context = ctx;
    }
    ...
    protected String doInBackground(String... params) {
        ...
        String upd_url = "https://qvayaapp.000webhostapp.com/MB/insertStudentNotifications.php";
        //String result = "";
