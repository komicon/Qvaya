...
public class ActivitySendPushNotificationHereXul extends AppCompatActivity implements RadioGroup.OnCheckedChangeListener, View.OnClickListener {
    ...
    private void loadRegisteredDevices() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, EndPointsHereXul.URL_FETCH_DEVICES__Here,
                        ...
                        try {
                            ...
                            if (!obj.getBoolean("error")) {
                                ...
                                ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(
                                        ActivitySendPushNotificationHereXul.this,
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, EndPointsHereXul.URL_SEND_MULTIPLE_PUSH_Here,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        Toast.makeText(ActivitySendPushNotificationHereXul.this, response, Toast.LENGTH_LONG).show();
                    }
                },
                new Response.ErrorListener() {
                    @Override
    ...
    private void sendSinglePush() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, EndPointsHereXul.URL_SEND_SINGLE_PUSH__Here,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        progressDialog.dismiss();
