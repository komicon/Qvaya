...
public class ActivitySendPushNotificationDelay extends AppCompatActivity implements RadioGroup.OnCheckedChangeListener, View.OnClickListener{
    ...
    private void loadRegisteredDevices() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, EndPointsDelays.URL_FETCH_DEVICES,
                        ...
                        try {
                            ...
                            if (!obj.getBoolean("error")) {
                                ...
                                ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(
                                        ActivitySendPushNotificationDelay.this,
    ...
    private void sendMultiplePush() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, EndPointsDelays.URL_SEND_MULTIPLE_PUSH,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        progressDialog.dismiss();

                        Toast.makeText(ActivitySendPushNotificationDelay.this, response, Toast.LENGTH_LONG).show();
                    }
                },
                new Response.ErrorListener() {
                    @Override
