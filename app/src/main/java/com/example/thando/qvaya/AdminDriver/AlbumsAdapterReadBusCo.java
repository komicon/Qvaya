 ...
 * Created by Thando
 */
public class AlbumsAdapterReadBusCo extends RecyclerView.Adapter<AlbumsAdapterReadBusCo.MyViewHolder> {

    private Context mContext;
    private List<AlbumReadBusCo> albumList;


    public AlbumsAdapterReadBusCo(Context mContext, List<AlbumReadBusCo> albumList) {
        this.mContext = mContext;
        this.albumList = albumList;
    }

    @Override
    public AlbumsAdapterReadBusCo.MyViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(final AlbumsAdapterReadBusCo.MyViewHolder viewHolder, int i) {
            ...
            itemView.setOnClickListener(new View.OnClickListener(){
                ...
                public void onClick(View v){
                    ...
                    if (pos != RecyclerView.NO_POSITION){
                        AlbumReadBusCo clickedDataItem = albumList.get(pos);
                        Intent intent = new Intent(mContext, DetailActivityReadBusCo.class);
