...

{
    ...
    public static final String URL_REGISTER_DEVICE =    "https://qvayaapp.000webhostapp.com/Wonder/pushNotification/RegisterDevice.php";
    public static final String URL_SEND_SINGLE_PUSH =   "https://qvayaapp.000webhostapp.com/Wonder/pushNotification/sendSinglePush.php";
    public static final String URL_SEND_MULTIPLE_PUSH = "https://qvayaapp.000webhostapp.com/Wonder/pushNotification/sendMultiplePush.php";
    public static final String URL_FETCH_DEVICES =      "https://qvayaapp.000webhostapp.com/Wonder/pushNotification/GetRegisteredDevices.php";
