...
public class AdminDeleteCoordinator extends AppCompatActivity {
                ...
                .setPositiveButton("OK",
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog,int id) {
                                ...
                                if(!error)
                                {
                                    Toast.makeText(AdminDeleteCoordinator .this, "Coordinator  Deleted", Toast.LENGTH_SHORT).show();
                                    ...
                                    if(userInput.getText().toString().length() < 5||userInput.getText().toString().isEmpty())
                                    {
                                        ...
                                        if(userInput.requestFocus()) {
                                            ...
                                            userInput.getText().clear();
                                            Toast.makeText(AdminDeleteCoordinator .this, "Invalid Password Must Have 5 digits", Toast.LENGTH_SHORT).show();
                                        }
                                    }
                                }
                            }
