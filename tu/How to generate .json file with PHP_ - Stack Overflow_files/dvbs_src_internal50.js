...
0,{}));b.hasOwnProperty("err")&&(c=b.err);return{vdcv:26,vdcd:b.res,err:c}}catch(e){return{vdcv:26,vdcd:"0",err:c}}}function R(c){for(var b=0;10>b&&c!=window._dv_win.top;)b++,c=c.parent;return b}function S(c){try{if(1>=c.depth)return{url:"",depth:""};var b=[];b.push({win:window._dv_win.top,depth:0});for(var e,f=1,d=0;0<f&&100>d;){try{if(d++,e=b.shift(),f--,0<e.win.location.toString().length&&e.win!=c)return 0==e.win.document.referrer.length||0==e.depth?{url:e.win.location,depth:e.depth}:{url:e.win.document.referrer,
depth:e.depth-1}}catch(k){}var g=e.win.frames.length;for(var m=0;m<g;m++)b.push({win:e.win.frames[m],depth:e.depth+1}),f++}return{url:"",depth:""}}catch(k){return{url:"",depth:""}}}function W(){var c=window._dv_win[F("=@42E:@?")][F("2?46DE@C~C:8:?D")];if(c&&0<c.length){var b=[];b[0]=window._dv_win.location.protocol+"//"+window._dv_win.location.hostname;for(var e=0;e<c.length;e++)b[e+1]=c[e];return b.reverse().join(",")}return null}function F(c){new String;var b=new String,e;for(e=0;e<c.length;e++){var f=
c.charAt(e);var d="!\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~".indexOf(f);0<=d&&(f="!\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~".charAt((d+47)%94));b+=f}return b}function y(){return Math.floor(1E12*(Math.random()+""))}function T(c){for(var b=[{id:4,brRegex:"OPR|Opera",verRegex:"(OPR/|Version/)"},{id:1,brRegex:"MSIE|Trident/7.*rv:11|rv:11.*Trident/7|Edge/",verRegex:"(MSIE |rv:| Edge/)"},{id:2,
...
c=void 0!=b.style.textShadow}catch(e){}return(0<Object.prototype.toString.call(window.HTMLElement).indexOf("Constructor")||window.webkitAudioPannerNode&&window.webkitConvertPointFromNodeToPage)&&c&&void 0!=window.innerWidth&&void 0!=window.innerHeight?5:0}catch(e){return 0}}function X(){try{var c=0,b=function(b,d){d&&32>b&&(c=(c|1<<b)>>>0)},e=function(b,c){return function(){return b.apply(c,arguments)}},f="svg"===document.documentElement.nodeName.toLowerCase(),d=function(){return"function"!==typeof document.createElement?
document.createElement(arguments[0]):f?document.createElementNS.call(document,"http://www.w3.org/2000/svg",arguments[0]):document.createElement.apply(document,arguments)},g=["Moz","O","ms","Webkit"],m=["moz","o","ms","webkit"],k={style:d("modernizr").style},q=function(b,c){function e(){f&&(delete k.style,delete k.modElem)}var g;for(g=["modernizr","tspan","samp"];!k.style&&g.length;){var f=!0;k.modElem=d(g.shift());k.style=k.modElem.style}var m=b.length;for(g=0;g<m;g++){var h=b[g];~(""+h).indexOf("-")&&
(h=cssToDOM(h));if(void 0!==k.style[h])return e(),"pfx"==c?h:!0}e();return!1},p=function(b,c,d){var f=b.charAt(0).toUpperCase()+b.slice(1),h=(b+" "+g.join(f+" ")+f).split(" ");if("string"===typeof c||"undefined"===typeof c)return q(h,c);h=(b+" "+m.join(f+" ")+f).split(" ");for(var k in h)if(h[k]in c){if(!1===d)return h[k];b=c[h[k]];return"function"===typeof b?e(b,d||c):b}return!1};b(0,!0);b(1,p("requestFileSystem",window));b(2,window.CSS?"function"==typeof window.CSS.escape:!1);b(3,p("shapeOutside",
"content-box",!0));return c}catch(n){return 0}}function J(){var c=window,b=0;try{for(;c.parent&&c!=c.parent&&c.parent.document&&!(c=c.parent,10<b++););}catch(e){}return c}function Y(){try{var c=J(),b=0,e=0,f=function(c,d,f){f&&(b=(b|1<<c)>>>0,e=(e|1<<d)>>>0)},d=c.document;f(14,0,c.playerInstance&&d.querySelector('script[src*="ads-player.com"]'));f(14,1,(c.CustomWLAdServer||c.DbcbdConfig)&&(a=d.querySelector('p[class="footerCopyright"]'),a&&a.textContent.match(/ MangaLife 2016/)));f(15,2,c.zpz&&c.zpz.createPlayer);
...
null!=a&&null!=(null!=a.querySelector('div[id*="opti-ad"]')||a.querySelector('iframe[src="about:blank"]'))):!1);f(17,10,c==c.top&&""==d.title&&c.InitAdPlayer?(a=d.querySelector('body>div[id="kt_player"]'),null!=a&&null!=a.querySelector('div[class="flash-blocker"]')):!1);f(17,11,null!=c.clickplayer&&null!=c.checkRdy2);f(19,12,c.instance&&c.inject&&d.querySelector('path[id="cp-search-0"]'));return{f:b,s:e}}catch(g){return null}}function Z(){try{var c="&fcifrms="+window.top.length;window.history&&(c+=
"&brh="+window.history.length);var b=J(),e=b.document;if(b==window.top){c+="&fwc="+((b.FB?1:0)+(b.twttr?2:0)+(b.outbrain?4:0)+(b._taboola?8:0));try{e.cookie&&(c+="&fcl="+e.cookie.length)}catch(f){}b.performance&&b.performance.timing&&0<b.performance.timing.domainLookupStart&&0<b.performance.timing.domainLookupEnd&&(c+="&flt="+(b.performance.timing.domainLookupEnd-b.performance.timing.domainLookupStart));e.querySelectorAll&&(c+="&fec="+e.querySelectorAll("*").length)}return c}catch(f){return""}}function V(){function c(b){if(null==
b||""==b)return"";var c=function(b,c){return b<<c|b>>>32-c},d=function(b){for(var c="",d,e=7;0<=e;e--)d=b>>>4*e&15,c+=d.toString(16);return c},e=[1518500249,1859775393,2400959708,3395469782];b+=String.fromCharCode(128);for(var f=Math.ceil((b.length/4+2)/16),g=Array(f),h=0;h<f;h++){g[h]=Array(16);for(var l=0;16>l;l++)g[h][l]=b.charCodeAt(64*h+4*l)<<24|b.charCodeAt(64*h+4*l+1)<<16|b.charCodeAt(64*h+4*l+2)<<8|b.charCodeAt(64*h+4*l+3)}g[f-1][14]=8*(b.length-1)/Math.pow(2,32);g[f-1][14]=Math.floor(g[f-
1][14]);g[f-1][15]=8*(b.length-1)&4294967295;b=1732584193;l=4023233417;var u=2562383102,r=271733878,A=3285377520,z=Array(80);for(h=0;h<f;h++){for(var t=0;16>t;t++)z[t]=g[h][t];for(t=16;80>t;t++)z[t]=c(z[t-3]^z[t-8]^z[t-14]^z[t-16],1);var C=b;var v=l;var w=u;var x=r;var y=A;for(t=0;80>t;t++){var E=Math.floor(t/20),B=c(C,5);a:{switch(E){case 0:var D=v&w^~v&x;break a;case 1:D=v^w^x;break a;case 2:D=v&w^v&x^w&x;break a;case 3:D=v^w^x;break a}D=void 0}E=B+D+y+e[E]+z[t]&4294967295;y=x;x=w;w=c(v,30);v=C;
C=E}b=b+C&4294967295;l=l+v&4294967295;u=u+w&4294967295;r=r+x&4294967295;A=A+y&4294967295}return d(b)+d(l)+d(u)+d(r)+d(A)}function b(){try{return!!window.sessionStorage}catch(g){return!0}}function e(){try{return!!window.localStorage}catch(g){return!0}}function f(){try{var b=document.createElement("canvas");if(b.getContext&&b.getContext("2d")){var c=b.getContext("2d");c.textBaseline="top";c.font="14px 'Arial'";c.textBaseline="alphabetic";c.fillStyle="#f60";c.fillRect(0,0,62,20);c.fillStyle="#069";c.fillText("!image!",
...
this.createRequest=function(){var c=!1,b=window._dv_win,e=0,f=!1,d;try{for(d=0;10>=d;d++)if(null!=b.parent&&b.parent!=b)if(0<b.parent.location.toString().length)b=b.parent,e++,c=!0;else{c=!1;break}else{0==d&&(c=!0);break}}catch(u){c=!1}0==b.document.referrer.length?c=b.location:c?c=b.location:(c=b.document.referrer,f=!0);if(!window._dv_win.dvbsScriptsInternal||!window._dv_win.dvbsProcessed||0==window._dv_win.dvbsScriptsInternal.length)return{isSev1:!1,url:null};var g=window._dv_win.dv_config&&window._dv_win.dv_config.isUT?
window._dv_win.dvbsScriptsInternal[window._dv_win.dvbsScriptsInternal.length-1]:window._dv_win.dvbsScriptsInternal.pop();d=g.script;this.dv_script_obj=g;this.dv_script=d;window._dv_win.dvbsProcessed.push(g);window._dv_win._dvScripts.push(d);var m=d.src;this.dvOther=0;this.dvStep=1;var k=window._dv_win.dv_config?window._dv_win.dv_config.bst2tid?window._dv_win.dv_config.bst2tid:window._dv_win.dv_config.dv_GetRnd?window._dv_win.dv_config.dv_GetRnd():y():y();g=window.parent.postMessage&&window.JSON;var q=
!0,p=!1;if("0"==dv_GetParam(m,"t2te")||window._dv_win.dv_config&&1==window._dv_win.dv_config.supressT2T)p=!0;if(g&&0==p)try{var n=G(window._dv_win.dv_config.bst2turl||"https://cdn3.doubleverify.com/bst2tv3.html","bst2t_"+k);q=B(n)}catch(u){}n={};try{p=/[\?&]([^&]*)=([^&#]*)/gi;for(var h=p.exec(m);null!=h;)"eparams"!==h[1]&&(n[h[1]]=h[2]),h=p.exec(m);var l=n}catch(u){l=n}l.perf=this.perf;l.uid=k;l.script=this.dv_script;l.callbackName="__verify_callback_"+l.uid;l.tagObjectCallbackName="__tagObject_callback_"+
l.uid;l.tagAdtag=null;l.tagPassback=null;l.tagIntegrityFlag="";l.tagHasPassbackFlag="";0==(null!=l.tagformat&&"2"==l.tagformat)&&(h=Q(l.script),l.tagAdtag=h.tagAdTag,l.tagPassback=h.tagPassback,h.isBadImp?l.tagIntegrityFlag="&isbadimp=1":h.hasPassback&&(l.tagHasPassbackFlag="&tagpb=1"));(h=(/iPhone|iPad|iPod|\(Apple TV|iOS|Coremedia|CFNetwork\/.*Darwin/i.test(navigator.userAgent)||navigator.vendor&&"apple, inc."===navigator.vendor.toLowerCase())&&!window.MSStream)?n="https:":(n=l.script.src,m="http:",
k=window._dv_win.location.toString().match("^http(?:s)?"),"https"!=n.match("^https")||"https"!=k&&"http"==k||(m="https:"),n=m);l.protocol=n;l.ssl="0";"https:"===l.protocol&&(l.ssl="1");n=l;(m=window._dv_win.dvRecoveryObj)?("2"!=n.tagformat&&(m=m[n.ctx]?m[n.ctx].RecoveryTagID:m._fallback_?m._fallback_.RecoveryTagID:1,1===m&&n.tagAdtag?document.write(n.tagAdtag):2===m&&n.tagPassback&&document.write(n.tagPassback)),n=!0):n=!1;if(n)return{isSev1:!0};this.dvStep=2;P(l,h);d=d&&d.parentElement&&d.parentElement.tagName&&
"HEAD"===d.parentElement.tagName;this.dvStep=3;return I(this,l,c,b,e,f,g,q,d,h)};this.sendRequest=function(c){var b=dv_GetParam(c,"tagformat");b&&"2"==b?$dvbs.domUtilities.addScriptResource(c,document.body):dv_sendScriptRequest(c);try{var e=M(this.dv_script_obj&&this.dv_script_obj.injScripts),f=G("about:blank");f.id=f.name;var d=f.id.replace("iframe_","");f.setAttribute&&f.setAttribute("data-dv-frm",d);B(f,this.dv_script);if(this.dv_script){var g=this.dv_script;a:{c=null;try{if(c=f.contentWindow){var m=
c;break a}}catch(p){}try{if(c=window._dv_win.frames&&window._dv_win.frames[f.name]){m=c;break a}}catch(p){}m=null}g.dvFrmWin=m}var k=N(f);if(k)k.open(),k.write(e);else{try{document.domain=document.domain}catch(p){}var q=encodeURIComponent(e.replace(/'/g,"\\'").replace(/\n|\r\n|\r/g,""));f.src='javascript: (function(){document.open();document.domain="'+window.document.domain+"\";document.write('"+q+"');})()"}}catch(p){e=(window._dv_win.dv_config=window._dv_win.dv_config||{}).tpsAddress||"tps30.doubleverify.com",
dv_SendErrorImp(e+"/verify.js?ctx=818052&cmp=1619415",[{dvp_jsErrMsg:"DvFrame: "+encodeURIComponent(p)}])}return!0};this.isApplicable=function(){return!0};this.onFailure=function(){};window.debugScript&&(window.CreateUrl=I);this.getVersionParamName=function(){return"ver"};this.getVersion=function(){return"100"}};
